...
(function (K) {
  ...
  const ZHOU_LI = {
    san: { title: '三兆（周礼・大卜）', items: ['玉兆', '瓦兆', '原兆'],
      quote: '三兆の法を掌る。一つ目を玉兆、二つ目を瓦兆、三つ目を原兆という。' },
    si: { title: '四兆（周礼・卜師）', items: ['方兆', '功兆', '義兆', '弓兆'],
      quote: '亀を開く四兆を掌る。一つ目を方兆、二つ目を功兆、三つ目を義兆、四つ目を弓兆という。' }
  };

  const SOURCES = [
    { title: '周礼・春官宗伯（大卜・卜師・龜人）', note: '三兆・四兆、「火を上げて亀を作り、その墨を致す」' },
    { title: '書経（尚書）・洪範 七稽疑', note: '卜五＝雨・霽・蒙・驛・克、「三人が占えば、二人の言に従う」' },
    { title: '史記・巻128 龜策列伝', note: '荊枝・堅木で灼く、「亀を灼いて兆を観る」、「占うときは必ず北を向く」' },
    { title: '礼記・玉藻', note: '「卜人は亀を選び、史が墨で兆を定め、君が体を定める」' },
